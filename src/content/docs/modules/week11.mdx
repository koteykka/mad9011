---
title: Week Eleven - Design Systems II

// TODO: add more notes and a video about web authentication, add a sample repo with a demo version for google maps, Update all the CORS notes
---
...
![Component Example](@assets/components-banner.png)
...
<YouTube title="Figma Tutorial: Components - The Basics" url="k74IrUNaJVk?si=h0GvncQBVj2Bft21" />

## Creating Component Variants

<YouTube title="Figma Tutorial: Variants" url="y29Xwt9dET0?si=RTlkMvLZ1HU-A2T0" />
...
![Component vs Code](@assets/component-code.png)
...
![Nested Components](@assets/nested-icon-components.png)
...
![Figma Community Banner](@assets/figma-community.png)
