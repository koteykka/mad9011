---
title: Week Fourteen - Presenting Your Concepts
---
...
![Design Review Process](@assets/designProcess.png)
...
![In-person, Low-tech](@assets/week14/1.png)

Utilize paper printouts, sketches, or a whiteboard.

![In-person, Mid-tech](@assets/week14/2.png)

Gather around a computer screen, or use a projector for slides and live demos.

![In-person, Mid-tech](@assets/week14/3.png)

Projector, slides, live demo, or the device itself

![Remote](@assets/week14/4.jpg)

Employ screen-sharing tools like WebEx, Zoom, Teams, Google Meet, or Skype.
