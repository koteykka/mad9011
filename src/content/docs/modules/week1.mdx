...
2. **Size Images for Screens:**Work in pixel dimensions rather than PPI, and export assets at the sizes modern phones actually need.
3. **Differentiate File Types:** Identify PSD, JPEG, PNG, SVG, and choose the right one for a given asset.
...
6. **Utilize Core Tools:** Gain proficiency in selection tools, image resizing, and basic masking.
...
8. **Design Across Formats:**Build a single artboard-based document and export one campaign concept at desktop, square, and vertical sizes.
