---
title: Week Thirteen - Interactive Visual Prototype

// TODO: build a code sample of a working version that adds a new stylesheet to a page.
---
...
<YouTube title="Figma Tutorial: Prototyping" url="-sAAa-CCOcg" />
...
![figma prototype interface](@assets/figma-prototype-interface.png)
...
![Figma add flows](@assets/figma-add-flows.gif)
...
![Figma add connection](@assets/figma-connect.gif)
...
![Figma connection anatomy](@assets/figma-connection-anatomy.png)
...
![Figma Interaction Panel](@assets/figma-add-interaction.png)
...
![Figma Animation Types](@assets/figma-animation-types.gif)
...
![Figma Animation curves](@assets/figma-curves.gif)
...
![Figma Fixed Position](@assets/figma-fixed-position.png)
...
![Figma Carousel](@assets/figma-overflow-scroll.png)
...
<YouTube title="Figma tutorial: Interactive components" url="ReNbXhaL3Xk" />
...
![Figma Prototyping Component](@assets/Figma-prototype-component.png)
...
![Figma Prototype Settings](@assets/figma-prototype-settings.png)
...
![Figma Prototype Play](@assets/Figma-play-icon.png)
...
![Figma Presentation layout](@assets/Figma-presentation-layout.png) -->
