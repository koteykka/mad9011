---
title: Week Ten - Design Systems I
---
...
![Design System Banner](@assets/design-system-banner.png)
...
<YouTube title="Build it in Figma: Create a Design System — Foundations" url="EK-pHkc5EL4?si=_iOUBnaFqggjYii4" />
...
![Color Palette Banner](@assets/color-banner.png)
...
![60-30-10 Color Rule](@assets/60-30-10.png)
...
![Example Colour Scheme](@assets/example-colours.png)
...
![Interactive Colors](@assets/interactive-colours.png)
...
![Denotative Colors](@assets/denotative-colors.png)
...
![Typography Banner](@assets/typography-banner.png)
...
![Novelty Font](@assets/novelty-typeface.png)
...
![Icon Grid](@assets/icon-grid.png)
...
![Icon component](@assets/icon-component.png)
...
<YouTube title="Figma Tutorial: Creating Styles" url="gtQ_A3imzsg?si=WFHEbMokOLgtvakq" />
